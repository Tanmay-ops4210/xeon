...
import { Search, Filter, MapPin, Calendar, ArrowRight, User, Star, Award, Loader2 } from 'lucide-react';
...
const mockSpeakers: Speaker[] = [
  {
    ...
    bio: 'Professional with 20 years of experience helping brands reach their goals through innovative technology solutions.',
  ...
  },
  {
    ...
    bio: 'Skilled in problem solving, communication, and strategic thinking with a focus on user-centered design.',
  ...
  },
  {
    ...
    bio: 'Dedicated to crafting innovative solutions with change-driven creativity and forward-thinking design.',
  ...
  },
  {
    ...
    bio: 'Leading digital transformation initiatives with expertise in data-driven marketing strategies.',
...
const expertiseAreas = ['All', 'Technology', 'Leadership', 'Design', 'Marketing', 'Strategy', 'Innovation'];
